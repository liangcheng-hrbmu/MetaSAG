...
inputFastq = Target_Path + "Barn/Trim/Samplename.fastq" # Consolidated file of all trimmed cell sequences belonging to the same sample

resultDir = Target_Path + "Cell_Filter/"

filter_path = Target_Path + "2_Cell_Filter/Filtered_Fastq"
